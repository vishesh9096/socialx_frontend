...
const ContextMenu = () => {
  ...
  // console.log(editor?.objects?.clipboard)
  ...
  if (!contextMenuRequest || !contextMenuRequest.target || !activeObject) {
    return <></>
  }
  ...
  if (contextMenuRequest.target.type === "Background") {
    return (
      ...
      >
        ...
        <ContextMenuItem
          disabled={editor?.objects?.clipboard === undefined ||editor?.objects?.clipboard === "" }
          onClick={() => {
